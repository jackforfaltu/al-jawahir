...
target_window_target="_self";
set_new_win=true;
target_window_property="";

dnum=new Array(false,2,"",3,'Kanz-al-Marjaan',0,'#000000',false);
dtitle=new Array(true,2,"",5,'Kanz-al-Marjaan',0,'#0000FF',false);
dmtitle=new Array(2,"",5,'Kanz-al-Marjaan',0,'#FF0000',true,false);
ddes=new Array(false,2,"",2,'Kanz-al-Marjaan',0,'#000000',false);
dmdes=new Array(2,"",4,'Kanz-al-Marjaan',0,'#FF0000',false,true);
dtext=new Array(true,2,"",5,'Kanz-al-Marjaan',0,'#000000',false);
dmtext=new Array(2,"",5,'Kanz-al-Marjaan',0,'#FF0000',false,true);
durl=new Array(false,2,"",2,'Kanz-al-Marjaan',0,'#008000',false);
dscore=new Array(false,2,"",2,'Kanz-al-Marjaan',0,'#008000',false);
ddate=new Array(false,2,"",2,'Kanz-al-Marjaan',0,'#008000',false);
max_match_title=80;
max_match_des=150;
max_match_text=100;
max_match_text_before=30;

search_item_num=100;
display_newsearch=false;
